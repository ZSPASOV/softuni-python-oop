class Vet:
    ...
    def __init__(self, name: str):
        self.name = name
        self.animals = [] # stores animals associated to a particular vet
    ...
    def info(self):
        ...
        return f'{vet_name} has {amount_of_vet_animals} animals.{space_left_in_clinic} space left in clinic'
